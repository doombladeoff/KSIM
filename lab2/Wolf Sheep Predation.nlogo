globals [ max-sheep
 					num_ticks]  ; don't let the sheep population grow too large
...
to go
  ...
  if not any? wolves and count sheep > max-sheep [ user-message "The sheep have inherited the earth" user-message(num_ticks)
    stop ]
  ask sheep [
    move-sheep
  ...
  set num_ticks num_ticks + 1
  if num_ticks > 500
  [
        user-message (word
      "Number of sheep " count sheep
          "Number of wolves " count wolves
    )
